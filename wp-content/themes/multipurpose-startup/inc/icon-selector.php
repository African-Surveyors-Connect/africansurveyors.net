...
class Multipurpose_Startup_Icon_Selector extends WP_Customize_Control{
      public $type = 'icon';
            ...
            <label>
                  ...
                  <ul class="icon-list">
                      <div class="social-icon-search">
                          <input class="socialInput" type="text" placeholder="<?php echo esc_attr('Search Icon', 'multipurpose-startup'); ?>">
                      </div>
                    <?php
                    $multipurpose_startup_font_awesome_icon_array = multipurpose_startup_font_awesome_icon_array();
                    foreach ($multipurpose_startup_font_awesome_icon_array as $multipurpose_startup_font_awesome_icon) {
                            $icon_class = $this->value() == $multipurpose_startup_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($multipurpose_startup_font_awesome_icon).'"></i>
                            <span class="multipurpose-startup-social-class">'.esc_attr($multipurpose_startup_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                  </ul>
...
function multipurpose_startup_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css');
}
add_action( 'customize_controls_enqueue_scripts', 'multipurpose_startup_customizer_script' );

if(!function_exists('multipurpose_startup_font_awesome_icon_array')){
    function multipurpose_startup_font_awesome_icon_array(){
