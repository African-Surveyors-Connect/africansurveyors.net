<?php $related_posts = multipurpose_startup_related_posts_function(); ?>

<?php if ( $related_posts->have_posts() ): ?>

	<div class="related-posts clearfix py-3">
		<?php if ( get_theme_mod('multipurpose_startup_related_posts_title','You May Also Like') != '' ) {?>
			<h2 class="related-posts-main-title"><?php echo esc_html( get_theme_mod('multipurpose_startup_related_posts_title',__('You May Also Like','multipurpose-startup')) ); ?></h2>
		<?php }?>
		<div class="row">
